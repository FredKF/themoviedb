...
export class MovieService {
  ...
  getMovies(movieType: string): Observable<RootObject>{
    return this.httpClient.get<RootObject>(`https://api.themoviedb.org/3/movie/${movieType}?api_key=82818e8e08f0fd22cb882c56c7a579fc&language=en-US&page=1`);
  }
