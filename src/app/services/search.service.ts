...
export class SearchService {
  ...
  getSearchResults(keyword: string): Observable<MovieRootObject>{
    ...
    return this.httpClient.get<MovieRootObject>(`https://api.themoviedb.org/3/search/multi?api_key=82818e8e08f0fd22cb882c56c7a579fc&language=en-US&query=${keyword}&page=1&include_adult=false`);    
  }
}